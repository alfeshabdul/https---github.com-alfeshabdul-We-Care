...
<div className="col-sm-6 col-md-4">
    <div className="team-item">
        <img src="https://tse4.mm.bing.net/th?id=OIP.I_06S6MYmA9xFtpa8A2lmQHaEo&pid=Api&P=0&h=180" className="team-img "alt="pic"></img>
        <h3> vedprakash</h3>
     ...
     <ul className="team-icon">
        ...
        <img src="https://cdn-icons-png.flaticon.com/128/3670/3670151.png" className="symbol"></img>
        </a>&nbsp;
 ...
 <img src="https://cdn-icons-png.flaticon.com/128/3955/3955024.png"className="symbol"></img>
        </a>&nbsp;
...
<img src="https://cdn-icons-png.flaticon.com/128/5968/5968764.png"className="symbol"></img>
        </a>&nbsp;
...
<img src="https://www.roadtocode.org/static/media/logo.8dd0bf20731ffeceb4ee.png"className="symbol"></img>
        </a>&nbsp;
     </ul>
    </div>
</div>
...
<div className="col-sm-6 col-md-4">
    <div className="team-item">
        ...
        <div className="team-info">
        <p>head of seo</p>
        <p>“Since you get more joy out of giving joy to other, you should put a  good deal of thought into the happiness that you are able to give.”</p>
     <ul className="team-icon">
