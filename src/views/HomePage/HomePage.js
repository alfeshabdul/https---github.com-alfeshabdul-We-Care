...
function HomePage() {
   return (
      <div>
         ...
         <div>
         <p><b className="heading">Welcome to WE-CARE - Empowering Change, Transforming Lives!</b>
...
<br></br> <b className=" heading">What We Stand For:</b>
...
<br></br> <b className=" heading">Get Involved, Be the Change:</b>
